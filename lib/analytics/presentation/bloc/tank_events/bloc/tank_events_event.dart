...
class FetchTankEventsEvent extends TankEventsEvent {
  /// Creates a fetch tank events event.
...
class SearchTankEventsEvent extends TankEventsEvent {
  /// The search query to filter tank events.
  final String query;
  
  /// Creates a search tank events event.
  /// 
  /// Parameters:
...
class RefreshTankEventsEvent extends TankEventsEvent {
  /// Creates a refresh tank events event.
