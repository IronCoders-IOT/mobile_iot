...
class Event{
  /// The type of event (e.g., 'water_reading', 'quality_alert').
  final String eventType;
  
  /// The water quality value (e.g., 'Excellent', 'Good', 'Bad').
  final String qualityValue;
  
  /// The water level value in liters or percentage.
  final String levelValue;
  
  /// The unique identifier of the sensor device that generated this event.
  final int deviceId;
  
  /// Creates an event with the specified parameters.
  /// 
  /// All parameters are required and represent the core data
  /// captured from the water tank sensor.
  Event({
