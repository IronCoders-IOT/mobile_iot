...
import 'package:mobile_iot/profiles/presentation/bloc/profile_edition/bloc/profile_edition_event.dart';
import 'package:mobile_iot/profiles/presentation/bloc/profile_edition/bloc/profile_edition_state.dart';
...
class ProfileEditionBloc extends Bloc<ProfileEditionEvent, ProfileEditionState> {
  /// Use case for profile-related operations.
  ...
  ///
  /// Emits:
  /// - [ProfileEditionLoadingState]
  /// - [ProfileEditionLoadedState]
  /// - [ProfileEditionErrorState]
  ...
  ///
  /// Emits:
  /// - [ProfileEditionUpdatingState]
  /// - [ProfileEditionUpdatedState]
  /// - [ProfileEditionErrorState]
