...
import 'package:mobile_iot/profiles/presentation/bloc/profile_view/bloc/profile_view_event.dart';
import 'package:mobile_iot/profiles/presentation/bloc/profile_view/bloc/profile_view_state.dart';
...
class ProfileViewBloc extends Bloc<ProfileViewEvent, ProfileViewState> {
  ...
  /// Creates a profile view BLoC with the required dependencies.
  ///
  /// Parameters:
